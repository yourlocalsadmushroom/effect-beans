...
public class PurpleSporebeanBagItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if(stack.isOf(ModItems.PURPLE_SPOREBEAN_BAG)) {
            tooltip.add(Text.literal("Contains 8 Purple Sporebeans").formatted(Formatting.DARK_PURPLE));
        }
        if(stack.isOf(ModItems.PURPLE_SPOREBEAN_BAG_7)) {
            tooltip.add(Text.literal("Contains 7 Purple Sporebeans").formatted(Formatting.DARK_PURPLE));
        }
        if(stack.isOf(ModItems.PURPLE_SPOREBEAN_BAG_6)) {
            tooltip.add(Text.literal("Contains 6 Purple Sporebeans").formatted(Formatting.DARK_PURPLE));
        }
        if(stack.isOf(ModItems.PURPLE_SPOREBEAN_BAG_5)) {
            tooltip.add(Text.literal("Contains 5 Purple Sporebeans").formatted(Formatting.DARK_PURPLE));
        }
        if(stack.isOf(ModItems.PURPLE_SPOREBEAN_BAG_4)) {
            tooltip.add(Text.literal("Contains 4 Purple Sporebeans").formatted(Formatting.DARK_PURPLE));
        }
        if(stack.isOf(ModItems.PURPLE_SPOREBEAN_BAG_3)) {
            tooltip.add(Text.literal("Contains 3 Purple Sporebeans").formatted(Formatting.DARK_PURPLE));
        }
        if(stack.isOf(ModItems.PURPLE_SPOREBEAN_BAG_2)) {
            tooltip.add(Text.literal("Contains 2 Purple Sporebeans").formatted(Formatting.DARK_PURPLE));
        }
        if(stack.isOf(ModItems.PURPLE_SPOREBEAN_BAG_1)) {
            tooltip.add(Text.literal("Contains 1 Purple Sporebean").formatted(Formatting.DARK_PURPLE));
        }
